...
public class DukeImageRecognition {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException, ClassNotFoundException {
        ...
        String dataSetPath = "DukeSet"; // path to folder which contain category sub fodlers with images
        ...
        RandomGenerator.getDefault().initSeed(123); // fix random generator to get repeatable training results
